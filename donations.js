...
function addDonation(id, amount, currency) {
  const donation = {
    id,
    pseudonym: gothicNames[id],
    amount: amount,
    currency: currency,
...
addDonation(34, 300, "BRL");

addDonation(4, 100, "EUR");
addDonation(40, 130, "EUR");
addDonation(60, 150, "EUR");
addDonation(65, 130, "EUR");
